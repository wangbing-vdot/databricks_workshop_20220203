...
# MAGIC %md
# MAGIC #Azure Databricks Data Science Hands On Workshop
...
# MAGIC %sql
# MAGIC select * from churndb.demographic
...
# DBTITLE 1,Install scikit-learn
...
# DBTITLE 1,Introduction to  Databricks AutoML
# MAGIC %md
...
model_uri = "runs:/80170491f2b347b5a962d62baf8dd130/model"
...
# DBTITLE 1,Taking one step Further than AutoML
# MAGIC %md
# MAGIC # Modeling
# MAGIC 
